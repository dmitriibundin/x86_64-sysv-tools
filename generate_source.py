...
if __name__ == "__main__":
    ...
    parser.add_argument("--c-header-nasm-inc-pairs", type=lambda str: [pair.split(':', 1) for pair in str.split(',')],
    ...
    flattened_dict = sum(args.c_header_nasm_inc_pairs, [])
    ...
    for c_header_path, nasm_header_path in args.c_header_nasm_inc_pairs:
        with open(c_header_path) as c_header_path_fd:
            c_header = c_header_path_fd.read()
